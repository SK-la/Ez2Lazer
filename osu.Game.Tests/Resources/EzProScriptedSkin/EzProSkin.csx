...
public class EzProSkin : Skin
{
    public static SkinInfo CreateInfo() => new SkinInfo
    {
        ...
        Creator = "(SK_la)",
        Protected = true,
        InstantiationInfo = typeof(EzProSkin).GetInvariantInstantiationInfo()
    };

    protected EzResourceStore? EzResources;

    public EzProSkin(IStorageResourceProvider resources)
        : this(CreateInfo(), resources)
    {
    }

    [UsedImplicitly(ImplicitUseKindFlags.InstantiatedWithFixedConstructorSignature)]
    public EzProSkin(SkinInfo skin, IStorageResourceProvider resources, IResourceStore<byte[]>? fallbackStore = null)
