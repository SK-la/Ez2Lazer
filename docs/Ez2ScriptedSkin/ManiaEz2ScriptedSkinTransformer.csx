...
public class ManiaEz2ScriptedSkinTransformer : SkinTransformer
{
    ...
    public ManiaEz2ScriptedSkinTransformer(ISkin skin, IBeatmap beatmap)
        : base(skin)
    {
    ...
    public override Drawable? GetDrawableComponent(ISkinComponentLookup lookup)
    {
        switch (lookup)
        {
            ...
            case SkinComponentLookup<HitResult>:
                // if (Skin is Ez2ScriptedSkin && resultComponent.Component > HitResult.Great)
