...
public class Ez2ScriptedSkin : Skin
{
    public static SkinInfo CreateInfo() => new SkinInfo
    {
        ...
        Creator = "SK_la",
        Protected = true,
        InstantiationInfo = typeof(Ez2ScriptedSkin).GetInvariantInstantiationInfo()
    };

    protected readonly IStorageResourceProvider Resources;

    public Ez2ScriptedSkin(IStorageResourceProvider resources)
        : this(CreateInfo(), resources)
    {
    }

    [UsedImplicitly(ImplicitUseKindFlags.InstantiatedWithFixedConstructorSignature)]
    public Ez2ScriptedSkin(SkinInfo skin, IStorageResourceProvider resources, IResourceStore<byte[]>? fallbackStore = null)
