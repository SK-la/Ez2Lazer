...
{
    /// <summary>
    /// BMS gameplay with replay-driven input (Autoplay / Cinema). Keeps BMS keysound BGM updates from <see cref="BmsPlayer"/>.
    /// </summary>
    public partial class BmsReplayPlayer : ReplayPlayer
    {
        ...
        public BmsReplayPlayer(Func<IBeatmap, IReadOnlyList<osu.Game.Rulesets.Mods.Mod>, Score> createScore)
