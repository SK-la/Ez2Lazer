...
namespace osu.Game.Rulesets.Mania.Tests.EzMania.ReplayJudge
{
    ...
    public class ManiaCrossSourceInvariantTest
    {
        ...
        public void TestSameEnvironmentFromScoreMatchesFromLive()
        {
            ...
            var fromScore = snapshotRun(score, beatmap, ManiaRuleset.ResolveEnvironment(score.ScoreInfo, GlobalConfigStore.EzConfig, ManiaReplayRunPurpose.ForStoredStatistics));
            var fromLive = snapshotRun(score, beatmap, ManiaRuleset.ResolveEnvironment(null, GlobalConfigStore.EzConfig, ManiaReplayRunPurpose.ForLiveAnalysis));
        ...
        private static (List<HitEvent> hitEvents, Dictionary<HitResult, int> statistics) snapshotRun(Score score, IBeatmap beatmap, IManiaGameplayEnvironment environment)
        {
