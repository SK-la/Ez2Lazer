...
namespace osu.Game.Rulesets.Mania.Tests.EzMania.ReplayJudge
{
    ...
    public class ManiaCrossSourceInvariantTest
    {
        ...
        public void TestSameEnvironmentFromScoreMatchesFromLive()
        {
            ...
            var fromScore = snapshotRun(score, beatmap, GameplayEnvironment.FromScore(score.ScoreInfo, GlobalConfigStore.EzConfig));
            var fromLive = snapshotRun(score, beatmap, GameplayEnvironment.FromLive(GlobalConfigStore.EzConfig));
