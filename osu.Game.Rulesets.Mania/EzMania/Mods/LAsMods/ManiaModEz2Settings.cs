...
namespace osu.Game.Rulesets.Mania.EzMania.Mods.LAsMods
{
    public class ManiaModEz2Settings : Mod, IApplicableToDifficulty, IApplicableToBeatmap //, IApplicableToSample //, IStoryboardElement
    {
        ...
        public static class Ez2SettingsStrings
        {
            ...
            public static readonly LocalisableString HEALTHY_SCRATCH_DESCRIPTION = new EzLocalizationManager.EzLocalisableString("优化盘子密度，通过特定模版将过快的盘子移动到其他列",
                "Healthy (EZ)Scratch. Move the fast Scratch to the other columns");
