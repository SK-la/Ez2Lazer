...
namespace osu.Game.Rulesets.Mania.EzMania.Mods.LAsMods
{
    ...
    public static class KrrLNStrings
    {
        ...
        public static readonly LocalisableString KRR_LN_MIN_LN_TO_NOTE_THRESHOLD_LABEL = new EzLocalizationManager.EzLocalisableString(
            "最短LN转Note", "Min LN to Note");

        public static readonly LocalisableString KRR_LN_MIN_LN_TO_NOTE_THRESHOLD_DESCRIPTION = new EzLocalizationManager.EzLocalisableString(
