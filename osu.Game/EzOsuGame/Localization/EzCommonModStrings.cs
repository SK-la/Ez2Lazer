...
namespace osu.Game.EzOsuGame.Localization
{
    public static class EzCommonModStrings
    {
        ...
        public static readonly LocalisableString GAP_DESCRIPTION = new EzLocalizationManager.EzLocalisableString("转换后改变随机列的音符数量间隙",
            "For changing random columns after transforming the gap's number of notes.");
