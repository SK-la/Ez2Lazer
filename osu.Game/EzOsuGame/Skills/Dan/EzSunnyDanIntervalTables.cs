...
// Auto-ported from mania-hub leoblack/estimator/intervals/*.js (default tables only).

namespace osu.Game.EzOsuGame.Skills.Dan
{
    internal static class EzSunnyDanIntervalTables
    {
        public static readonly (double Lower, double Upper, string Name)[] Rc4K =
        {
        ...
        public static readonly (double Lower, double Upper, string Name)[] Ln4K =
        {
        ...
        public static readonly (double Lower, double Upper, string Name)[] Rc6K =
        {
        ...
        public static readonly (double Lower, double Upper, string Name)[] Ln6K =
        {
        ...
        public static readonly (double Lower, double Upper, string Name)[] Rc7K =
        {
        ...
        public static readonly (double Lower, double Upper, string Name)[] Ln7K =
        {
