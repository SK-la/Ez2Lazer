...
namespace osu.Game.EzOsuGame.Analysis
{
    ...
    public readonly record struct EzRulesetSpecificRadarResult(EzRadarChartData<string> KeyPatternRadarData, EzRadarChartData<string> XxySrPatternRadarData, double? XxySr);
