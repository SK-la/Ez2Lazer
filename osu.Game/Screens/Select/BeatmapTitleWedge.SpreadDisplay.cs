...
namespace osu.Game.Screens.Select
{
    ...
    {
        /// <summary>
        /// Wedge-local difficulty spread: windowed around the current beatmap (max 11 siblings + "+N").
        /// Unlike <see cref="PanelBeatmapSet.SpreadDisplay"/>, does not rely on carousel <c>VisibleBeatmaps</c>.
        /// </summary>
