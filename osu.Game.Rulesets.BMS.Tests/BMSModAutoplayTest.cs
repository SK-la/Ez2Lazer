...
namespace osu.Game.Rulesets.BMS.Tests
{
    ...
    public class BMSModAutoplayTest
    {
        ...
        [Test]
        public void TestBmsModAutoplayBelongsToBmsRuleset()
        {
            var ruleset = new BMSRuleset();
            Assert.That(ModUtils.CheckModsBelongToRuleset(ruleset, new[] { new BMSModAutoplay() }), Is.True);
            Assert.That(ModUtils.CheckModsBelongToRuleset(ruleset, new[] { new ManiaModAutoplay() }), Is.False);
        }
