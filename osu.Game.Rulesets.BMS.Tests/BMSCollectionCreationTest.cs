...
namespace osu.Game.Rulesets.BMS.Tests
{
    ...
    public class BMSCollectionCreationTest
    {
        ...
        public void TestCollectionNameWithDuplicateHandling()
        {
            ...
            if (usedCollectionNames.ContainsKey(name1))
            {
                usedCollectionNames[name1]++;
                name1 = $"{name1} ({usedCollectionNames[name1]})";
            }
            else
            {
            ...
            if (usedCollectionNames.ContainsKey(name2))
            {
                usedCollectionNames[name2]++;
                name2 = $"{name2} ({usedCollectionNames[name2]})";
            }
            else
            {
            ...
            if (usedCollectionNames.ContainsKey(name3))
            {
                usedCollectionNames[name3]++;
                name3 = $"{name3} ({usedCollectionNames[name3]})";
            }
            else
            {
